<%@ Page Title="" Language="C#" MasterPageFile="~/Salubrious_Web/SalubriousMasterPage.Master" AutoEventWireup="true" CodeBehind="DietPlan.aspx.cs" Inherits="Salubrious_System.Salubrious_Web.DietPlan" %>
                  ...
                  <div class="input-group mb-3">
                   <div>
                     ...
                     <asp:TextBox ID="txtDiseaseName" ClientIDMode="Static" runat="server" Class="form-control" style="border-radius:5px;background-color:transparent;color:white"></asp:TextBox>
                       <br /><br />
                     <asp:Button ID="btnDoctDetails" runat="server" Text="Search" OnClick="DietDetails_Click" class="btn btn-warning col-md-4" style="margin-top:5%;"/>
                  </div>
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="City">
                                <ItemTemplate>
                                    ...
                                    <asp:Button ID="btnDownload" Text="View" runat="server" CommandName="Select" CommandArgument="<%#Container.DataItemIndex%>" OnClientClick="openInNewTab();" />
                                </ItemTemplate>
